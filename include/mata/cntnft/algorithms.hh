...
#ifndef MATA_CNTNFT_INTERNALS_HH
#define MATA_CNTNFT_INTERNALS_HH
 ...
 *
 * This is a separation of the implementation from the interface defined in mata::cntnft.
 * Note, that in mata::cntnft interface, there are particular dispatch functions calling
 ...
 */
namespace mata::cntnft::algorithms {
...
#endif // MATA_CNTNFT_INTERNALS_HH
