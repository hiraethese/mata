/* cntnft.hh -- Nondeterministic finite automaton (over finite words).
 */

#ifndef MATA_CNTNFT_HH
#define MATA_CNTNFT_HH
 ...
 *   3. Constructions.
 *
 * Other algorithms are included in mata::cntnft::Plumbing (simplified API for, e.g., binding)
 * and mata::cntnft::algorithms (concrete implementations of algorithms, such as for complement).
 */
...
namespace std {
    std::ostream& operator<<(std::ostream& os, const mata::cntnft::Nft& nft);
} // namespace std.

#endif // MATA_CNTNFT_HH
