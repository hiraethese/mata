/* cntnft-incl.cc -- NFT language inclusion
 */
...
bool mata::cntnft::algorithms::is_included_naive(
        const Nft &smaller,
        const Nft &bigger,
...
bool mata::cntnft::algorithms::is_included_antichains(
    const Nft&             smaller,
    const Nft&             bigger,
...
bool mata::cntnft::are_equivalent(const Nft& lhs, const Nft& rhs, const Alphabet *alphabet, const JumpMode jump_mode, const ParameterMap& params)
{
...
bool mata::cntnft::are_equivalent(const Nft& lhs, const Nft& rhs, const JumpMode jump_mode, const ParameterMap& params) {
