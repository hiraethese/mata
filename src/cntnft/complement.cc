...
Nft mata::cntnft::algorithms::complement_classical(const Nft& aut, const OrdVector<Symbol>& symbols,
...
Nft mata::cntnft::complement(const Nft& aut, const Alphabet& alphabet, const ParameterMap& params) {
    return mata::cntnft::complement(aut, alphabet.get_alphabet_symbols(), params);
}

Nft mata::cntnft::complement(const Nft& aut, const mata::utils::OrdVector<mata::Symbol>& symbols, const ParameterMap& params) {
    Nft result;
