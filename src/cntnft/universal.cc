/* cntnft-universal.cc -- NFT universality
 */
...
bool mata::cntnft::algorithms::is_universal_naive(
	const Nft&         aut,
...
bool mata::cntnft::algorithms::is_universal_antichains(
	const Nft&         aut,
	const Alphabet&    alphabet,
	Run*               cex)
{
...
bool mata::cntnft::Nft::is_universal(const Alphabet& alphabet, Run* cex, const ParameterMap& params) const {
...
bool mata::cntnft::Nft::is_universal(const Alphabet& alphabet, const ParameterMap& params) const {
