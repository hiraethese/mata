...
using mata::cntnft::Nft;
using cntnft::strings::ReplaceMode;
using cntnft::strings::ReluctantReplace;
...
Nft mata::cntnft::strings::create_identity(mata::Alphabet* alphabet, const size_t num_of_levels) {
...
Nft mata::cntnft::strings::create_identity_with_single_symbol_replace(
...
Nft cntnft::strings::create_identity_with_single_symbol_replace(Alphabet* alphabet, const Symbol from_symbol,
...
Nft mata::cntnft::strings::replace_reluctant_regex(
...
Nft ReluctantReplace::marker_nft(const nfa::Nfa& marker_dfa, Symbol marker) {
    Nft dft_marker{ cntnft::builder::create_from_nfa(marker_dfa) };
...
Nft ReluctantReplace::reluctant_leftmost_nft(nfa::Nfa nfa, Alphabet* alphabet, Symbol begin_marker,
    ...
    Nft nft_reluctant_leftmost{
        cntnft::builder::create_from_nfa(nfa, 2, { EPSILON }, { EPSILON }) };
...
Nft cntnft::strings::replace_reluctant_literal(const Word& literal, const Word& replacement, Alphabet* alphabet,
...
Nft cntnft::strings::replace_reluctant_single_symbol(Symbol from_symbol, const Word& replacement, mata::Alphabet* alphabet,
                                                  ReplaceMode replace_mode) {
    return ReluctantReplace::replace_symbol(from_symbol, replacement, alphabet, replace_mode);
}

Nft cntnft::strings::replace_reluctant_single_symbol(Symbol from_symbol, Symbol replacement, mata::Alphabet* alphabet,
                                                  ReplaceMode replace_mode) {
    return ReluctantReplace::replace_symbol(from_symbol, replacement, alphabet, replace_mode);
}
